...
export default function page() {
    return (
        <main className='py-12 px-5 gap-5 w-fit flex flex-col min-h-[calc(100vh-5rem)] max-w-[45rem] text-white'>
            <h1 className='font-bold text-2xl uppercase mt-10'>
                Objetivo y guía de utilización
            </h1>
            <p>
                La aplicación tiene como objetivo principal el facilitar una gestión eficiente
                de los plazos, permitiendo calcular con precisión las fechas término
                optimizando así la planificación de tareas.
            </p>
            <p>
                La aplicación se apoya en calendarios proporcionados por instituciones
                académicas y profesionales, asegurando la máxima precisión al tener en cuenta
                eventos y días relevantes para la práctica jurídica.
            </p>
            <section>
                ...
                <ol className='flex flex-col gap-8 list-decimal'>
                    <li>
                        ...
                        <ul className='flex flex-col gap-4 ml-10 mt-2 list-disc'>
                            <li>
                                <span className='font-semibold'>Derecho Laboral:</span> Es el
                                filtro por defecto al ingresar al sitio, cuyo plazo se computa
                                solamente en días hábiles.
                            </li>
                            <li>
                            ...
                            <li>
                                <span className='font-semibold'>Personalizado: </span>Consiste
                                en modificar manualmente las casillas para ajustar el filtro a
                                las necesidades del caso concreto.
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul className='flex flex-col gap-4 ml-10 mt-2 list-disc'>
                            <li>
                                ...
                                Al hacer clic sobre el campo, se despliega un calendario
                                permitiendo seleccionar una fecha.
                            </li>
                            <li>
                                <span className='font-semibold'>Plazo en días: </span>
                                Se debe ingresar el plazo. Dependiendo del filtro seleccionado,
                                el valor predefinido puede ser de 15 o 30 días.
                            </li>
                        </ul>
                    </li>
                    <li>
            ...
            <div className='flex text-4xl gap-3 items-center text-blue-400'>
                ...
                <Link
                    target='_blank'
                    className='hover:text-white'
                    href='https://github.com/Dev-Santi'
                >
                    <FaGithubSquare />
                </Link>
                <Link
